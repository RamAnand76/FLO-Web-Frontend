...
export default function MetricCard({ label, value, change }: { label: string; value: string; change: string; }) {
  ...
  return (
    <div className="metric-card-premium group animate-slide-in-up">
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className={`w-2.5 h-2.5 rounded-full ${isPositive ? 'bg-emerald-400 animate-pulse-subtle' : 'bg-rose-400 animate-pulse-subtle'}`}></div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <div className={`flex items-center space-x-1 ${isPositive ? 'text-emerald-600' : 'text-rose-600'}`}>
